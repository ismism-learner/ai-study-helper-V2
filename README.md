...
### 痛点1：学习资料分散难管理
**解决方案**：统一管理PDF书籍、文本文档，支持文件夹、标签、国家、时间多维度分类

### 痛点2：文档理解耗时费力
**解决方案**：AI自动提取框架、术语解释，快速把握文档核心内容

### 痛点3：知识点关联困难
**解决方案**：时间轴系统串联历史事件，国家分类展示地理关联
...
### Q: 地图显示异常？
**A:** 运行 `python backend\init_countries.py` 初始化国家数据
