...
class OCRService:
    ...
    async def process_pdf(self, file_path: str, start_page: int = 0, end_page: int | None = None) -> list[OCRPageResult]:
    ...
    async def _process_with_mineru(self, file_path: str, start_page: int, end_page: int | None) -> list[OCRPageResult]:
    ...
    async def _process_with_pymupdf(self, file_path: str, start_page: int, end_page: int | None) -> list[OCRPageResult]:
        import fitz
